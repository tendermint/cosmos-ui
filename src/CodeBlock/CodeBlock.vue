    ...
    <span class="container">
        ...
        <span class="body__block">
          <span class="icons">
            <span class="icons__item" v-if="height &gt; 300 &amp;&amp; expanded">
              <svg class="icons__item__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="expand(false)">
          ...
          <span class="icons__item">
            <svg class="icons__item__icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" @click="copy(value)">
          ...
          <span class="body__wrapper">
            ...
            <span class="expand" :class="[`expand__expanded__${!!expanded}`]">
              <span class="expand__item expand__item__expand" @click="expand(true)" v-if="!expanded">
                <span>Expand</span>
                <svg class="expand__item__icon" width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="footer" v-if="url">
        ...
        <a class="footer__source" :href="url" target="_blank" rel="noreferrer noopener">
          ...
          <svg class="footer__source__icon" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
